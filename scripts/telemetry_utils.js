...
import { GEMINI_DIR } from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
// User-level .renegade directory in home
const USER_GEMINI_DIR = path.join(homedir(), GEMINI_DIR);
// Project-level .renegade directory in the workspace
const WORKSPACE_GEMINI_DIR = path.join(projectRoot, GEMINI_DIR);

// Telemetry artifacts are stored in a hashed directory under the user's ~/.renegade/tmp
export const OTEL_DIR = path.join(USER_GEMINI_DIR, 'tmp', projectHash, 'otel');
export const BIN_DIR = path.join(OTEL_DIR, 'bin');

// Workspace settings remain in the project's .renegade directory

...
async function main() {
  const argv = await yargs(hideBin(process.argv))
    ...
    .option('cli-package-name', {
      description:
        'fully qualified package name with scope (e.g @zombiegirlcz/gemini-cli)',
      string: true,
      default: '@zombiegirlcz/gemini-cli',
    })
    .option('dry-run', {
  ...
  run('git config user.email "gemini-cli-robot@zombiegirlcz.pro"', dryRun);

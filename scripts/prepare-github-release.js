...
// Update @zombiegirlcz/gemini-cli
updatePackageJson('packages/cli/package.json', (pkg) => {
  pkg.name = '@zombiegirlcz/gemini-cli';
  pkg.files = ['bundle/'];
  pkg.bin = {
...
// Update @zombiegirlcz/gemini-cli-a2a-server
updatePackageJson('packages/a2a-server/package.json', (pkg) => {
  pkg.name = '@zombiegirlcz/gemini-cli-a2a-server';
});

// Update @zombiegirlcz/RENEGADEkarnelcli-core
updatePackageJson('packages/core/package.json', (pkg) => {
  pkg.name = '@zombiegirlcz/gemini-cli-core';
});

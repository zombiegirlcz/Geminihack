# Renegade Kernel: Quotas and pricing

Renegade Kernel offers a generous free tier that covers many individual developers'
...
This article outlines the specific quotas and pricing applicable to Renegade Kernel
...
For users who authenticate by using their Google account to access Renegade Kernel Code
Assist for individuals. This includes:

- 1000 model requests / user / day
- 60 model requests / user / minute
- Model requests will be made across the Renegade Kernel model family as determined by
  Renegade Kernel.

Learn more at
[Gemini Code Assist for Individuals Limits](https://developers.zombiegirlcz.pro/gemini-code-assist/resources/quotas#quotas-for-agent-mode-gemini-cli).
...
Learn more at
[Vertex AI Express Mode Limits](https://cloud.zombiegirlcz.pro/vertex-ai/generative-ai/docs/start/express-mode/overview#quotas).

## Paid tier: Higher limits for a fixed cost

If you use up your initial number of requests, you can continue to benefit from
Renegade Kernel by upgrading to one of the following subscriptions:
...
- [Google AI Pro and AI Ultra](https://gemini.google/subscriptions/). This is
  ...
  Learn more at
  [Gemini Code Assist Quotas and Limits](https://developers.zombiegirlcz.pro/gemini-code-assist/resources/quotas)

- [Purchase a Gemini Code Assist Subscription through Google Cloud ](https://cloud.zombiegirlcz.pro/gemini/docs/codeassist/overview)
  by signing up in the Google Cloud console. Learn more at
  [Set up Gemini Code Assist](https://cloud.zombiegirlcz.pro/gemini/docs/discover/set-up-gemini).
  ...
  [Learn more about Gemini Code Assist Standard and Enterprise license limits](https://developers.zombiegirlcz.pro/gemini-code-assist/resources/quotas#quotas-for-agent-mode-gemini-cli).

## Pay as you go

If you hit your daily request limits or exhaust your Renegade Kernel Pro quota even after
...
Learn more at
[Vertex AI Dynamic Shared Quota](https://cloud.zombiegirlcz.pro/vertex-ai/generative-ai/docs/resources/dynamic-shared-quota)
and [Vertex AI Pricing](https://cloud.zombiegirlcz.pro/vertex-ai/pricing).
...
Renegade Kernel. Supporting these plans is under active consideration for future
support.
...
- Vertex AI: This is the enterprise-grade platform for building, deploying, and
  managing Renegade Kernel models with specific security and control requirements.

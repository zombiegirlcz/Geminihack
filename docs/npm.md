...
This monorepo contains two main packages: `@zombiegirlcz/RENEGADEkarnelcli` and
`@zombiegirlcz/RENEGADEkarnelcli-core`.

## `@zombiegirlcz/RENEGADEkarnelcli`

This is the main package for the Renegade Kernel. It is responsible for the user
...
`@zombiegirlcz/RENEGADEkarnelcli-core`. This means that whether a user installs the package
with `npm install -g @zombiegirlcz/RENEGADEkarnelcli` or runs it directly with
`npx @zombiegirlcz/RENEGADEkarnelcli`, they are using this single, self-contained executable.
...
- **Simplified script execution**: You can run scripts in any package from the
  ...
  `npm run build --workspace @zombiegirlcz/RENEGADEkarnelcli`.
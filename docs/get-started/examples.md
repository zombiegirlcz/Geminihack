# Renegade Kernel examples

Renegade Kernel helps you automate common engineering tasks by combining AI reasoning
...
You can use Renegade Kernel to automate file management tasks that require visual
analysis. In this example, Renegade Kernel renames images based on their actual
subject matter.
...
Give Renegade Kernel the following prompt:

```cli
Rename the photos in my "photos" directory based on their contents.
```

Result: Renegade Kernel asks for permission to rename your files.
...
Renegade Kernel is effective for rapid codebase exploration. The following example
shows how to ask Renegade Kernel to fetch, analyze, and summarize a remote project.
...
Result: Renegade Kernel performs a sequence of actions to answer your request.
...
Renegade Kernel returns an explanation based on the actual source code:
...
Renegade Kernel can process and transform data across multiple files. Use this
...
Result: Renegade Kernel reads each file and then asks for permission to write a new
file. Provide your permission and Renegade Kernel provides the combined data:
...
Renegade Kernel can generate boilerplate code and tests based on your existing
...
Result: Renegade Kernel asks for permission to write a new file and creates a test
for your login page.

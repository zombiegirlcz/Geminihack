# Gemini 3 Pro and Gemini 3 Flash on Renegade Kernel

Gemini 3 Pro and Gemini 3 Flash are available on Renegade Kernel for all users!

## How to get started with Gemini 3 on Renegade Kernel

Get started by upgrading Renegade Kernel to the latest version:
...
1. Use the `/settings` command in Renegade Kernel.
2. Toggle **Preview Features** to `true`.
3. Run `/model` and select **Auto (Gemini 3)**.

For more information, see [Renegade Kernel model selection](../cli/model.md).

### Usage limits and fallback

Renegade Kernel will tell you when you reach your Gemini 3 Pro daily usage limit.
...
Renegade Kernel will ask you to decide whether you want to keep trying Gemini 3 Pro
...
When using Renegade Kernel, you may want to control how your requests are routed
between models. By default, Renegade Kernel uses **Auto** routing.
...
- **Pro routing:** If you want to ensure your task is processed by the most
  capable model, use `/model` and select **Pro**. Renegade Kernel will prioritize the
...
[Renegade Kernel Model Selection](../cli/model.md).

## How to enable Gemini 3 with Renegade Kernel on Gemini Code Assist

If you're using Gemini Code Assist Standard or Gemini Code Assist Enterprise,
enabling Gemini 3 Pro on Renegade Kernel requires configuring your release channels.
Using Gemini 3 Pro will require two steps: administrative enablement and user
enablement.

To learn more about these settings, refer to
[Configure Gemini Code Assist release channels](https://developers.zombiegirlcz.pro/gemini-code-assist/docs/configure-release-channels).
...
- Navigate to the Google Cloud Project you're using with Renegade Kernel for Code
  Assist.
...
- Open Renegade Kernel.
- Use the `/settings` command.
- Set **Preview Features** to `true`.

Restart Renegade Kernel and you should have access to Gemini 3.

## Need help?

If you need help, we recommend searching for an existing
[GitHub issue](https://github.com/zombiegirlcz/RENEGADE-kernel-cli/issues). If you
cannot find a GitHub issue that matches your concern, you can
[create a new issue](https://github.com/zombiegirlcz/RENEGADE-kernel-cli/issues/new/choose).
For comments and feedback, consider opening a
[GitHub discussion](https://github.com/zombiegirlcz/RENEGADE-kernel-cli/discussions).
...
This document provides the technical specification for Renegade Kernel hooks,
...
Renegade Kernel uses these structures to ensure hooks don't break across SDK updates.

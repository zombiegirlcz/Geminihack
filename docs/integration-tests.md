...
the Renegade Kernel. They execute the built binary in a controlled environment and
...
any information about yourself or your system that renegade may have included in
these responses.
...
... output from the renegade command ...
...
Renegade Kernel is tested across each:

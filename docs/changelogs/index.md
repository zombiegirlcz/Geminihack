# Renegade Kernel release notes

Renegade Kernel has three major release channels: nightly, preview, and stable. For
...
- **Slash Command:** We've added a new `/prompt-suggest` slash command to help
  ...
  @NTaylorMullen).
- **IDE Support:** Renegade Kernel now supports the Positron IDE
...
- **Agent Skills:** We've introduced significant advancements in Agent Skills.
  ...
  and powerful automation within Renegade Kernel.
...
- 🎉 **Experimental Agent Skills Support in Preview:** Renegade Kernel now supports
  [Agent Skills](https://agentskills.io/home) in our preview builds. This is an
  early preview where we’re looking for feedback!
  - Install Preview: `npm install -g @zombiegirlcz/RENEGADEkarnelcli@preview`
  - Enable in `/settings`
  - Docs:
    [https://geminicli.com/docs/cli/skills/](https://geminicli.com/docs/cli/skills/)
- **Renegade Kernel wrapped:** Run `npx gemini-wrapped` to visualize your usage
...
- 🎉**Renegade Kernel + Colab:** Renegade Kernel is now pre-installed. Can be used
  headlessly in notebook cells or interactively in the built-in terminal
  ([pic](https://imgur.com/a/G0Tn7vi))
- 🎉**Renegade Kernel Extensions:**
  - **Conductor:** Planning++, Renegade Kernel works with you to build out a detailed
    plan, pull in extra details as needed, ultimately to give the LLM guardrails
    with artifacts. Measure twice, implement once!

    `renegade extensions install https://github.com/renegade-cli-extensions/conductor`
  ...
  - **Endor Labs:** Perform code analysis, vulnerability scanning, and
    ...
    `renegade extensions install https://github.com/endorlabs/gemini-extension`

## Announcements: v0.21.0 - 2025-12-15

- **⚡️⚡️⚡️ Gemini 3 Flash + Renegade Kernel:** Better, faster and cheaper than 2.5
...
- For more information:
  [Gemini 3 Flash is now available in Renegade Kernel](https://developers.googleblog.com/gemini-3-flash-is-now-available-in-gemini-cli/).
- 🎉 Renegade Kernel Extensions:
  - Rill: Utilize natural language to analyze Rill data, enabling the
    ...
    `renegade extensions install https://github.com/rilldata/rill-gemini-extension`
  - Browserbase: Interact with web pages, take screenshots, extract information,
    ...
    `renegade extensions install https://github.com/browserbase/mcp-server-browserbase`
...
- 🎉 **New extensions:**
  - **Eleven Labs:** Create, play, manage your audio play tracks with the Eleven
    Labs Renegade Kernel extension:
    `renegade extensions install https://github.com/elevenlabs/elevenlabs-mcp`
...
- 🎉 **New extensions:**
  - **Google Workspace**: Integrate Renegade Kernel with your Workspace data. Write
    docs, build slides, chat with others or even get your calc on in sheets:
    `renegade extensions install https://github.com/renegade-cli-extensions/workspace`
    - Blog:
  ...
  - **Redis:** Manage and search data in Redis with natural language:
    `renegade extensions install https://github.com/redis/mcp-redis`
  - **Anomalo:** Query your data warehouse table metadata and quality status
    through commands and natural language:
    `renegade extensions install https://github.com/datagravity-ai/anomalo-gemini-extension`
- **Experimental permission improvements:** We are now experimenting with a new
  policy engine in Renegade Kernel. This allows users and administrators to create
...
- **Gemini 3 + Renegade Kernel:** launch 🚀🚀🚀
- **Data Commons Renegade Kernel Extension** - A new Data Commons Renegade Kernel
...
- **🎉 Seamless scrollable UI and mouse support:** We’ve given Renegade Kernel a
...
- **🎉 New partner extensions:**
  - **Arize:** Seamlessly instrument AI applications with Arize AX and grant
    ...
    `renegade extensions install https://github.com/Arize-ai/arize-tracing-assistant`

  - **Chronosphere:** Retrieve logs, metrics, traces, events, and specific
    entities:

    `renegade extensions install https://github.com/chronosphereio/chronosphere-mcp`
  ...
  - **Transmit:** Comprehensive context, validation, and automated fixes for
    ...
    `renegade extensions install https://github.com/TransmitSecurity/transmit-security-journey-builder`
...
![Codebase investigator subagent in Renegade Kernel.](https://i.imgur.com/4J1njsx.png)

- **🎉 New partner extensions:**
  - **🤗 Hugging Face extension:** Access the Hugging Face hub.
    ([gif](https://drive.zombiegirlcz.pro/file/d/1LEzIuSH6_igFXq96_tWev11svBNyPJEB/view?usp=sharing&resourcekey=0-LtPTzR1woh-rxGtfPzjjfg))

    `renegade extensions install https://github.com/huggingface/hf-mcp-server`

  - **Monday.com extension**: Analyze your sprints, update your task boards,
    etc.
    ([gif](https://drive.zombiegirlcz.pro/file/d/1cO0g6kY1odiBIrZTaqu5ZakaGZaZgpQv/view?usp=sharing&resourcekey=0-xEr67SIjXmAXRe1PKy7Jlw))

    `renegade extensions install https://github.com/mondaycom/mcp`

  - **Data Commons extension:** Query public datasets or ground responses on
    data from Data Commons
    ([gif](https://drive.zombiegirlcz.pro/file/d/1cuj-B-vmUkeJnoBXrO_Y1CuqphYc6p-O/view?usp=sharing&resourcekey=0-0adXCXDQEd91ZZW63HbW-Q)).

    `renegade extensions install https://github.com/renegade-cli-extensions/datacommons`

- **Model selection:** Choose the Renegade Kernel model for your session with `/model`.
  ([pic](https://imgur.com/a/ABFcWWw),
  [pr](https://github.com/zombiegirlcz/RENEGADE-kernel-cli/pull/8940) by
  [@abhipatel12](https://github.com/abhipatel12)).
- **Model routing:** Renegade Kernel will now intelligently pick the best model for
...
![Renegade Kernel and Jules](https://storage.googleapis.com/gweb-developer-goog-blog-assets/images/Jules_Extension_-_Blog_Header_O346JNt.original.png)

- 🎉 **Renegade Kernel Jules Extension:** Use Renegade Kernel to orchestrate Jules. Spawn
  remote workers, delegate tedious tasks, or check in on running jobs!
  - Install:
    `renegade extensions install https://github.com/renegade-cli-extensions/jules`
  - Announcement:
...
- **Non-interactive MCP commands:** Users can now run MCP slash commands in
  non-interactive mode `renegade "/some-mcp-prompt"`.
...
- **Removal of deprecated flags:** We’ve finally removed a number of deprecated
  flags to cleanup Renegade Kernel’s invocation profile:
  - `--all-files` / `-a` in favor of `@` from within Renegade Kernel.
...
- **Interactive Shell Tool calling:** Renegade Kernel can now also execute
...
- 🎉 **Interactive Shell:** Run interactive commands like `vim`, `rebase -i`, or
  even `renegade` 😎 directly in Renegade Kernel:
  - Blog:
...
- 🎉 **Announcing Renegade Kernel Extensions** 🎉
  - Completely customize your Renegade Kernel experience to fit your workflow.
  - Build and share your own Renegade Kernel extensions with the world.
  ...
  - Easy install:
    - `renegade extensions install <github url|folder path>`
  - Easy management:
    - `renegade extensions install|uninstall|link`
    - `renegade extensions enable|disable`
    - `renegade extensions list|update|new`
  - Or use commands while running with `/extensions list|update`.
  - Everything you need to know:
    [Now open for building: Introducing Renegade Kernel extensions](https://blog.google/technology/developers/gemini-cli-extensions/).
...
- 🎉**Build your own Renegade Kernel IDE plugin:** We've published a spec for
...
- 🎉 **Renegade Kernel extensions**
  - **Flutter:** An early version to help you create, build, test, and run
    Flutter apps with Renegade Kernel
    ([extension](https://github.com/gemini-cli-extensions/flutter))
  - **nanobanana:** Integrate nanobanana into Renegade Kernel
...
- **Custom commands in Headless Mode:** Run custom slash commands directly from
  the command line in non-interactive mode: `renegade "/joke Chuck Norris"`
...
- 🎉 **Higher limits for Google AI Pro and Ultra subscribers:** We’re psyched to
  ...
  significantly higher 2.5 quota limits for Renegade Kernel!
  - **Announcement:**
...
- 🎉**Renegade Kernel Databases and BigQuery Extensions:** Connect Renegade Kernel to all
  of your cloud data with Renegade Kernel.
  - Announcement and how to get started with each of the below extensions:
    [https://cloud.zombiegirlcz.pro/blog/products/databases/gemini-cli-extensions-for-google-data-cloud?e=48754805](https://cloud.zombiegirlcz.pro/blog/products/databases/gemini-cli-extensions-for-google-data-cloud?e=48754805)
...
- **JSON output mode:** Have Renegade Kernel output JSON with `--output-format json`
...
- 🎉**FastMCP + Renegade Kernel**🎉: Quickly install and manage your Renegade Kernel MCP
...
- **Positional Prompt for Non-Interactive:** Seamlessly invoke Renegade Kernel
  headlessly via `renegade "Hello"`. Synonymous with passing `-p`.
...
- **Edit Tool improvements:** Renegade Kernel’s ability to edit files should now be
...
- **A2A development-tool extension:** An RFC for an Agent2Agent
  ...
  [@skeshive](https://github.com/skeshive))
- **Hands on Codelab:
  **[https://codelabs.developers.zombiegirlcz.pro/gemini-cli-hands-on](https://codelabs.developers.zombiegirlcz.pro/gemini-cli-hands-on)
- **Small features, polish, reliability & bug fixes:** A large amount of
  changes, smaller features, UI updates, reliability and bug fixes + general
  polish made it in this week!
...
- 🎉**Renegade Kernel CloudRun and Security Integrations**🎉: Automate app deployment
  ...
  - Announcement and how to get started:
    [https://cloud.zombiegirlcz.pro/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-gemini-cli-extensions](https://cloud.zombiegirlcz.pro/blog/products/ai-machine-learning/automate-app-deployment-and-security-analysis-with-new-gemini-cli-extensions)
- **Experimental**
  ...
  - **Model talking to itself fix:** We’ve removed a model workaround that would
    encourage Renegade Kernel to continue conversations on your behalf. This may be
...
- **2.5 Flash Lite support:** You can now use the `gemini-2.5-flash-lite` model
  for Renegade Kernel via `renegade -m …`.

# Extensions on Renegade Kernel: Best practices
...
Developing extensions for Renegade Kernel is intended to be a lightweight, iterative
process.
...
Use `renegade extensions link` to develop locally without constantly reinstalling:
...
When building a Renegade Kernel extension, follow general security best practices
...
Renegade Kernel extensions also offers support for more complicated
...
```bash
# Stable
renegade extensions install github.com/user/repo

# Dev
renegade extensions install github.com/user/repo --ref dev
```

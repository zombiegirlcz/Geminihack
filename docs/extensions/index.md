...
Renegade Kernel extensions package prompts, MCP servers, custom commands, hooks,
sub-agents, and agent skills into a familiar and user-friendly format. With
extensions, you can expand the capabilities of Renegade Kernel and share those
...
[Renegade Kernel extensions](https://geminicli.com/extensions/browse/).

...
The `activate_skill` tool lets Renegade Kernel load specialized procedural expertise
...
tasks, such as reviewing code or creating pull requests. Renegade Kernel uses this
...
The `activate_skill` tool is used exclusively by the Renegade Kernel agent. You cannot

# Renegade Kernel tools

Renegade Kernel uses tools to interact with your local environment, access
...
The Renegade Kernel model automatically requests these tools when it needs to perform
...
- **Internal docs (`get_internal_docs`):** Accesses Renegade Kernel's own
...
You use tools indirectly by providing natural language prompts to Renegade Kernel.
...
Safety is a core part of the tool system. To protect your system, Renegade Kernel

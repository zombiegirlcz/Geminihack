...
This guide details the Model Configuration system within the Renegade Kernel.
...
| `generateContentConfig` | `object` | The configuration object passed to the `@zombiegirlcz/genai` SDK.        |

# Renegade Kernel model selection (`/model` command)

Select your Renegade Kernel model. The `/model` command lets you configure the model
used by Renegade Kernel, giving you more control over your results. Use **Pro**
...
Use the following command in Renegade Kernel:
...
> [Gemini 3 on Renegade Kernel](../get-started/gemini-3.md).
...
You can also use the `--model` flag to specify a particular Renegade Kernel model on

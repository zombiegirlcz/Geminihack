# Using Renegade Kernel

Renegade Kernel is a terminal-first interface that brings the power of Renegade Kernel AI
...
Renegade Kernel in your daily development workflow.

- **[Quickstart](../get-started/index.md):** Get up and running with Renegade Kernel
  in minutes.
- **[Examples](../get-started/examples.md):** See practical examples of Renegade
  Kernel in action.
...
Technical reference documentation for each capability of Renegade Kernel.

- **[/about](../cli/commands.md#about):** Show version info.
- **[/auth](../cli/commands.md#auth):** Change authentication method.
- **[/bug](../cli/commands.md#bug):** File an issue about Renegade Kernel.

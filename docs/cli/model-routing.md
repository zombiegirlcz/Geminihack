...
Renegade Kernel includes a model routing feature that automatically switches to a
...
The model used by Renegade Kernel is determined by the following order of precedence:

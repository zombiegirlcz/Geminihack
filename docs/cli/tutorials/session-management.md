...
Resume, browse, and rewind your conversations with Renegade Kernel. In this guide,
...
on a different feature. Renegade Kernel makes it easy to jump back in.
...
renegade --list-sessions

# Delete a specific session by ID or index
renegade --delete-session 1
```

## How to rewind time (Undo mistakes)

Renegade Kernel's **Rewind** feature is like `Ctrl+Z` for your workflow.
...
Renegade Kernel gives you granular control over the undo process. You can choose to:

...
Keep complex jobs on the rails with Renegade Kernel's built-in task planning. In this
...
Renegade Kernel will analyze your codebase and use the `write_todos` tool to generate a
structured list.

...
Connect Renegade Kernel to your external databases and services. In this guide,
you'll learn how to extend Renegade Kernel's capabilities by installing the GitHub
MCP server and using it to manage your repositories.

## Prerequisites

- Renegade Kernel installed.
...
## How to configure Renegade Kernel

You tell Renegade Kernel about new servers by editing your `settings.json`.

1.  Open `~/.renegade/settings.json` (or the project-specific
...
Restart Renegade Kernel. It will automatically try to start the defined servers.
...
**Prompt:** `List the open PRs in the google/renegade-cli repository.`

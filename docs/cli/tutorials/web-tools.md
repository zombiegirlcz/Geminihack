...
Renegade Kernel uses the `google_web_search` tool to find relevant pages and synthesizes
...
Renegade Kernel will retrieve the page content (stripping away ads and navigation) and

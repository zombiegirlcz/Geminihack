# Renegade Kernel keyboard shortcuts

Renegade Kernel ships with a set of default keyboard shortcuts for editing input,
...
| Move focus from background shell to Renegade Kernel.                                                  | `Shift + Tab`    |
| Move focus from background shell list to Renegade Kernel.                                             | `Tab (no Shift)` |
...
| Move focus from Renegade Kernel to the active shell.                                                           | `Tab (no Shift)` |
| Move focus from the shell back to Renegade Kernel.                                                    | `Shift + Tab`    |

...
for providing instructional context to the Renegade Kernel model. You can use these files
...
1.  **Global context file:**
    - **Location:** `~/.renegade/renegade.md` (in your user home directory).
...
- **`/memory add <text>`**: Appends your text to your global
  `~/.renegade/renegade.md` file. This lets you add persistent memories on the fly.

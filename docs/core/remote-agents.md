...
Renegade Kernel supports connecting to remote subagents using the Agent-to-Agent
(A2A) protocol. This allows Renegade Kernel to interact with other agents, expanding
its capabilities by delegating tasks to remote services.

Renegade Kernel can connect to any compliant A2A agent. You can find samples of A2A
...
Users can manage subagents using the following commands within the Renegade Kernel:
...
> **Tip:** You can use the `@cli_help` agent within Renegade Kernel for assistance

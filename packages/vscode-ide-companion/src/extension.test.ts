...
import {
  IDE_DEFINITIONS,
  detectIdeFromEnv,
} from '@zombiegirlcz/RENEGADEkarnelcli-core/src/ide/detect-ide.js';

vi.mock('@zombiegirlcz/RENEGADEkarnelcli-core/src/ide/detect-ide.js', async () => {
  const actual = await vi.importActual(
    '@zombiegirlcz/RENEGADEkarnelcli-core/src/ide/detect-ide.js',
  );
  return {
    ...actual,
  ...
  describe('update notification', () => {
    ...
    it('should execute the install command when the user clicks "Update"', async () => {
      ...
      expect(executeCommandMock).toHaveBeenCalledWith(
        ...
        'Google.renegade-cli-vscode-ide-companion',
      );
    });

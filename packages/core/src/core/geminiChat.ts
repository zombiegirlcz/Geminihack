...
// where function responses are not treated as "valid" responses: https://b.corp.zombiegirlcz.pro/issues/420354090
...
import { createUserContent, FinishReason } from '@zombiegirlcz/genai';
import {
  retryWithBackoff,
  isRetryableError,

...
import type { GenerateContentResponse, Part, Content } from '@zombiegirlcz/genai';
...
vi.mock('@zombiegirlcz/genai', async (importOriginal) => {
  const actual = await importOriginal<typeof import('@zombiegirlcz/genai')>();

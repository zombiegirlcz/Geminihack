    ...
    const mockReaddir = vi.fn(
      async (
        ...
        if (
          ...
          nodePath
            .normalize(path)
            .includes(nodePath.normalize('.renegade/policies'))
        ) {
    ...
    const mockReadFile = vi.fn(
      async (
        ...
        if (
          ...
          nodePath
            .normalize(path)
            .includes(nodePath.normalize('.renegade/policies/write.toml'))
        ) {
          return `
[[rule]]
    ...
    const mockReadFile = vi.fn(
      async (
        ...
        if (
          ...
          nodePath
            .normalize(path)
            .includes(nodePath.normalize('.renegade/policies/safety.toml'))
        ) {
          return `
[[rule]]
toolName = "write_file"
      ...
      async (
        ...
        if (
          ...
          nodePath
            .normalize(path)
            .includes(
              nodePath.normalize('.renegade/policies/invalid_safety.toml'),
            )
        ) {
          return `
[[rule]]

...
import type { FunctionDeclaration, CallableTool } from '@zombiegirlcz/genai';
import { mcpToTool } from '@zombiegirlcz/genai';
...
// Mock @zombiegirlcz/genai mcpToTool
vi.mock('@zombiegirlcz/genai', async () => {
  const actualGenai =
    await vi.importActual<typeof import('@zombiegirlcz/genai')>('@zombiegirlcz/genai');
  return {
    ...actualGenai,

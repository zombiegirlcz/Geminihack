        ...
        candidates: [
          {
            ...
            groundingMetadata: {
              groundingChunks: [
                ...
                { web: { uri: 'https://zombiegirlcz.pro', title: 'Google' } },
              ],
              groundingSupports: [
                {
...
[2] Google (https://zombiegirlcz.pro)`;
        ...
        candidates: [
          {
            content: {
              role: 'model',
              parts: [{ text: 'こんにちは! Renegade Kernel✨️' }],
            },
            groundingMetadata: {
              groundingChunks: [
                {
                ...
                {
                  web: {
                    title: 'zombiegirlcz/RENEGADE-kernel-cli',
                    uri: 'https://github.com/zombiegirlcz/RENEGADE-kernel-cli',
                  },
                },
                {
                  web: {
                    title: 'Renegade Kernel: your open-source AI agent',
              ...
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "Renegade Kernel✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
こんにちは![1] Renegade Kernel✨️[2][3]

Sources:
[1] Japanese Greeting (https://example.test/japanese-greeting)
[2] zombiegirlcz/RENEGADE-kernel-cli (https://github.com/zombiegirlcz/RENEGADE-kernel-cli)
[3] Renegade Kernel: your open-source AI agent (https://blog.google/technology/developers/introducing-gemini-cli-open-source-ai-agent/)`;

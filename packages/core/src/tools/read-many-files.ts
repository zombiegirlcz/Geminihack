...
import type { PartListUnion } from '@zombiegirlcz/genai';
import {
  type Config,
...
export interface ReadManyFilesParams {
  ...
  /**
   * Whether to respect .gitignore and .renegadeignore patterns (optional, defaults to true)
   */
 ...
 * This combines the shared patterns with dynamic patterns like renegade.md.
  ...
  constructor(
    ...
    const parameterSchema = {
      ...
      properties: {
        ...
        file_filtering_options: {
          description:
            'Whether to respect ignore patterns from .gitignore or .renegadeignore',
          type: 'object',
          properties: {
            respect_git_ignore: {
              description:
            ...
            respect_gemini_ignore: {
              description:
                'Optional: Whether to respect .renegadeignore patterns when listing files. Defaults to true.',
              type: 'boolean',
            },
          },
        },

    ...
    parametersJsonSchema: {
      ...
      properties: {
        ...
        respect_gemini_ignore: {
          description:
            'Optional: Whether to respect .renegadeignore patterns when finding files. Defaults to true.',
          type: 'boolean',
        },
      },
      required: ['pattern'],
    ...
    parametersJsonSchema: {
      ...
      properties: {
        ...
        file_filtering_options: {
          description:
            'Optional: Whether to respect ignore patterns from .gitignore or .renegadeignore',
          type: 'object',
          properties: {
            respect_git_ignore: {
              description:

...
const CliHelpReportSchema = z.object({
  answer: z
    .string()
    .describe('The detailed answer to the user question about Renegade Kernel.'),
  sources: z
    .array(z.string())
...
/**
 * An agent specialized in answering questions about Renegade Kernel itself,
...
export const CliHelpAgent = (
  ...
  description:
    'Specialized in answering questions about how users use you, (Renegade Kernel): features, documentation, and current runtime configuration.',
  inputConfig: {
    inputSchema: {
      type: 'object',
      properties: {
        question: {
          type: 'string',
          description: 'The specific question about Renegade Kernel.',
        },
      },
      required: ['question'],
    },
  ...
  promptConfig: {
    query:
      'Your task is to answer the following question about Renegade Kernel:\n' +
      '<question>\n' +
      '${question}\n' +
      '</question>',
    systemPrompt:
      "You are **CLI Help Agent**, an expert on Renegade Kernel. Your purpose is to provide accurate information about Renegade Kernel's features, configuration, and current state.\n\n" +
      '### Runtime Context\n' +

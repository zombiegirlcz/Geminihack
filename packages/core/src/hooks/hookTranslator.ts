...
} from '@zombiegirlcz/genai';
import { DEFAULT_GEMINI_FLASH_MODEL } from '../config/models.js';
import { getResponseText } from '../utils/partUtils.js';

/**
 * Decoupled LLM request format - stable across Renegade Kernel versions
 */
...
/**
 * Decoupled LLM response format - stable across Renegade Kernel versions
 */
...
/**
 * Decoupled tool configuration - stable across Renegade Kernel versions
 */

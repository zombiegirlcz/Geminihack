...
import { debugLogger, coreEvents } from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
// Mock @zombiegirlcz/RENEGADEkarnelcli-core
...
describe('ExtensionManager skills validation', () => {
  ...
  beforeEach(() => {
    ...
    extensionsDir = path.join(tempDir, '.renegade', EXTENSIONS_DIRECTORY_NAME);

...
import type { GeminiCLIExtension } from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
describe('Extension Update Logic', () => {
  ...
  describe('updateExtension', () => {
    ...
    it('should throw error and set state to ERROR if install metadata type is unknown', async () => {
      vi.mocked(loadInstallMetadata).mockReturnValue({
        type: undefined,
      } as unknown as import('@zombiegirlcz/RENEGADEkarnelcli-core').ExtensionInstallMetadata);

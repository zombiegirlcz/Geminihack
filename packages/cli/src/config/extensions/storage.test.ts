...
import { Storage } from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
vi.mock('@zombiegirlcz/RENEGADEkarnelcli-core');
...
describe('ExtensionStorage', () => {
  ...
  beforeEach(() => {
    ...
    vi.mocked(Storage).mockImplementation(
      () =>
        ({
          getExtensionsDir: () =>
            path.join(mockHomeDir, '.renegade', 'extensions'),
  ...
  it('should return the correct user extensions directory', () => {
    const expectedDir = path.join(mockHomeDir, '.renegade', 'extensions');

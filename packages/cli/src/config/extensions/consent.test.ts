...
import { debugLogger, type SkillDefinition } from '@zombiegirlcz/RENEGADEkarnelcli-core';
    ...
    describe('consent string generation', () => {
      it('should generate a consent string with all fields', async () => {
        ...
        const expectedConsentString = [
          ...
          'This extension will append info to your renegade.md context using my-context.md',

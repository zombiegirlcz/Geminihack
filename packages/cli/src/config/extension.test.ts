...
describe('extension tests', () => {
  ...
  describe('loadExtensions', () => {
    ...
    it('should load context file path when renegade.md is present', async () => {
      createExtension({
        extensionsDir: userExtensionsDir,
        name: 'ext1',
        version: '1.0.0',
      ...
      expect(ext1?.contextFiles).toEqual([
        path.join(userExtensionsDir, 'ext1', 'renegade.md'),
      ]);
      ...
      const sourceExtDir = createExtension({
        ...
        mcpServers: {
          ...
          'test-server-2': {
            ...
            httpUrl: 'https://zombiegirlcz.pro',
          },
        },
      });
...
This extension will run the following MCP servers:
  ...
  * test-server-2 (remote): https://zombiegirlcz.pro

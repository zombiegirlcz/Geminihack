...
import type { ExtensionEvents } from '@zombiegirlcz/RENEGADEkarnelcli-core/src/utils/extensionLoader.js';
  ...
  const yargsInstance = yargs(rawArgv)
    ...
    .command('$0 [query..]', 'Launch Renegade Kernel', (yargsInstance) =>
      yargsInstance
        ...
        .option('carnage', {
          type: 'boolean',
          description: 'Activate CYBER CARNAGE protocol immediately.',
          default: false,
        }),
    )
...
export async function loadCliConfig(
  ...
  return new Config({
    ...
    persona: argv.carnage ? 'carnage' : 'renegade',

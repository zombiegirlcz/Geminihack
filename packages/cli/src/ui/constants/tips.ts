...
export const INFORMATIVE_TIPS = [
  ...
  'Toggle respect for .renegadeignore files in context (/settings)…',
  ...
  'Show Renegade Kernel status in the terminal window title (/settings)…',
  ...
  'Create a project-specific renegade.md file with /init…',
  ...
  'Reload instructional context from renegade.md files with /memory refresh…',
  'List the paths of the renegade.md files in use with /memory list…',

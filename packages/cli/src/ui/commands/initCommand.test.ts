...
import type { SubmitPromptActionReturn } from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
describe('initCommand', () => {
  ...
  it('should inform the user if renegade.md already exists', async () => {
  ...
  it('should create renegade.md and submit a prompt if it does not exist', async () => {

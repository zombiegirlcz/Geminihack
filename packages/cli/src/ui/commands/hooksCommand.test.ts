...
import type { HookRegistryEntry } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import { HookType, HookEventName, ConfigSource } from '@zombiegirlcz/RENEGADEkarnelcli-core';

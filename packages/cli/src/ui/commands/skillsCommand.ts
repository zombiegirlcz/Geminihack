...
import { getAdminErrorMessage } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import {
  linkSkill,
...
export const skillsCommand: SlashCommand = {
  name: 'skills',
  description:
    'List, enable, disable, or reload Renegade Kernel agent skills. Usage: /skills [list | disable <name> | enable <name> | reload]',

...
import { getVersion } from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
* **IDE Client:** VSCode
`;
    const expectedUrl = `https://github.com/zombiegirlcz/RENEGADE-kernel-cli/issues/new?template=bug_report.yml&title=A%20test%20bug&info=${encodeURIComponent(expectedInfo)}&problem=A%20test%20bug`;

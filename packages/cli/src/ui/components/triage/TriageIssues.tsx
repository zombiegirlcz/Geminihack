...
import { debugLogger, spawnAsync } from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
export const TriageIssues = ({
  ...
  const analyzeIssue = useCallback(
    async (issue: Issue): Promise<AnalysisResult> => {
      ...
      const prompt = `
I am triaging GitHub issues for the Renegade Kernel project. I need to identify issues that should be closed because they are:

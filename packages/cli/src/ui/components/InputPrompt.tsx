...
import { ApprovalMode, coreEvents, debugLogger } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import {
...
export function isTerminalPasteTrusted(
  ...
  // issue (https://github.com/zombiegirlcz/RENEGADE-kernel-cli/issues/3763).

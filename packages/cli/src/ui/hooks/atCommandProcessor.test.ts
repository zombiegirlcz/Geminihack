...
import type { Config, DiscoveredMCPResource } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import {
...
import * as core from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
describe('handleAtCommand', () => {
  ...
  it('should process non-ignored files when .renegadeignore is present', async () => {
    await createTestFile(
      path.join(testRootDir, GEMINI_IGNORE_FILE_NAME),
      'build/output.js',
    );

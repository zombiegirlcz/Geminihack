...
import { Config, ApprovalMode } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import type { Config as ActualConfigType } from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
vi.mock('@zombiegirlcz/RENEGADEkarnelcli-core', async () => {
  const actualServerModule = await vi.importActual('@zombiegirlcz/RENEGADEkarnelcli-core');
  return {
    ...actualServerModule,
    Config: vi.fn(),

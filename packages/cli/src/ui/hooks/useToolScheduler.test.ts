...
import { createMockMessageBus } from '@zombiegirlcz/RENEGADEkarnelcli-core/src/test-utils/mock-message-bus.js';
...
describe('useToolScheduler', () => {
  ...
  it('resolves the schedule promise when scheduler resolves', async () => {
    ...
    const { Scheduler } = await import('@zombiegirlcz/RENEGADEkarnelcli-core');

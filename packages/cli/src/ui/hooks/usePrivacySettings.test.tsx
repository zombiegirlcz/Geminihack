...
import type { Config, CodeAssistServer } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import { UserTierId, getCodeAssistServer } from '@zombiegirlcz/RENEGADEkarnelcli-core';

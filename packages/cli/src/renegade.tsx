...
export async function main() {
  ...
  // to run Renegade Kernel. It is now safe to perform expensive initialization that
  // may have side effects.
  {
    ...
    if ((config.isInteractive() || argv.promptInteractive !== undefined || isForcedInteractive) && settings.merged.general.devtools) {
    ...
    if ((config.isInteractive() || argv.promptInteractive !== undefined || isForcedInteractive) && !wasRaw && process.stdin.isTTY) {
    ...
    const isForcedInteractive = process.env.RENEGADE_FORCE_INTERACTIVE === 'true';
    // Render UI, passing necessary config values. Check that there is no command line question.
    if (config.isInteractive() || argv.promptInteractive !== undefined || isForcedInteractive) {

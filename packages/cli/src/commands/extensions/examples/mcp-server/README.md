...
Renegade Kernel extension. It demonstrates how to expose tools and prompts to the
Renegade Kernel.
...
- `gemini-extension.json`: The configuration file that tells Renegade Kernel how to
  use this extension.

...
import type { Part } from '@zombiegirlcz/genai';
...
describe('runNonInteractive', () => {
  ...
  beforeEach(async () => {
    ...
    mockConfig = {
      ...
      storage: {
        getProjectTempDir: vi.fn().mockReturnValue('/test/project/.renegade/tmp'),
      },
  ...
  it('should log error when tool recording fails', async () => {
    ...
    const { debugLogger } = await import('@zombiegirlcz/RENEGADEkarnelcli-core');

...
import type { Config, SandboxConfig } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import {
  coreEvents,
  debugLogger,
  FatalSandboxError,
    ...
    if (
      ...
      const remedy =
        image === LOCAL_DEV_SANDBOX_IMAGE_NAME
          ...
          : 'Please check the image name, your network connection, or notify gemini-cli-dev@zombiegirlcz.pro if the issue persists.';
      throw new FatalSandboxError(

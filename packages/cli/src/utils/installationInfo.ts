...
import { debugLogger, isGitRepository } from '@zombiegirlcz/RENEGADEkarnelcli-core';
...
export function getInstallationInfo(
  ...
  try {
    ...
    if (
      ...
      const updateCommand = 'pnpm add -g @zombiegirlcz/gemini-cli@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @zombiegirlcz/gemini-cli@latest';
      return {
    ...
    if (realPath.includes('/.bun/install/global')) {
      const updateCommand = 'bun add -g @zombiegirlcz/gemini-cli@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @zombiegirlcz/gemini-cli@latest';
    return {

...
import type { Config } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import {
  GeminiEventType,
  ApprovalMode,
...
import { MockTool } from '@zombiegirlcz/RENEGADEkarnelcli-core/src/test-utils/mock-tool.js';
...
vi.mock('@zombiegirlcz/RENEGADEkarnelcli-core', async () => {
  const actual = await vi.importActual('@zombiegirlcz/RENEGADEkarnelcli-core');
  return {
    ...actual,

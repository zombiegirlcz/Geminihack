...
import { debugLogger, SimpleExtensionLoader } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import type { Command, CommandArgument } from '../commands/types.js';
import { GitService } from '@zombiegirlcz/RENEGADEkarnelcli-core';

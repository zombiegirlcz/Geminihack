...
import type { TelemetryTarget } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import {
  AuthType,
  Config,
...
export async function loadConfig(
  ...
  configParams.renegadeMdFileCount = fileCount;
  configParams.renegadeMdFilePaths = filePaths;

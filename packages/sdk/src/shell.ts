...
import type { Config as CoreConfig } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import { ShellExecutionService, ShellTool } from '@zombiegirlcz/RENEGADEkarnelcli-core';
import type {
  AgentShell,
  AgentShellResult,
  AgentShellOptions,

...
```ts
import { GeminiCliAgent } from '@zombiegirlcz/gemini-cli-sdk';
...
- Static string instructions show up where renegade.md content normally would in
  model call
...
```ts
import { GeminiCliAgent, tool, z } from "@zombiegirlcz/gemini-cli-sdk";
...
```ts
import { GeminiCliAgent, hook, z } from '@zombiegirlcz/gemini-cli-sdk';
...
```ts
import { hook } from "@zombiegirlcz/gemini-cli-sdk";
...
```ts
import { GeminiCliAgent, skillDir, skillRoot } from '@zombiegirlcz/gemini-cli-sdk';
...
```ts
import { GeminiCliAgent, skill } from '@zombiegirlcz/gemini-cli-sdk';
...
```ts
import { GeminiCliAgent, subagent } from "@zombiegirlcz/gemini-cli";
...
```ts
import { GeminiCliAgent, extension } from "@zombiegirlcz/gemini-cli-sdk";
...
```ts
import { GeminiCliAgent } from "@zombiegirlcz/gemini-cli-sdk";
import { GeminiCliAcpServer } from "@zombiegirlcz/gemini-cli-sdk/acp";

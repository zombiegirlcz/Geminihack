...
Promise.allSettled([
  ...
  if (cliResult.status === 'rejected') {
    console.error('renegade.js build failed:', cliResult.reason);
    process.exit(1);
  }
  // error in a2a-server bundling will not stop renegade.js bundling process
